            ...
            <>
                <header className="sidebar">
                    <div className="logo" style={{ padding: 0 }}>
                        ...
                        <span style={{ marginLeft: '0.5rem', fontWeight: 700 }}>HRMS</span>
                    </div>
                ...
                {isMobileMenuOpen && (
                    <div style={{
                        ...
                        <nav className="nav-links" style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                            {user?.role === 'admin' && (
                            ...
                            <div style={{ margin: '1.5rem 0', borderTop: '1px solid var(--border-color)', paddingTop: '1.5rem' }}>
                                <button onClick={toggleTheme} className="nav-item" style={{ width: '100%', background: 'transparent', border: 'none', marginBottom: '0.5rem' }}>
                                    <div className="nav-item-content">
                                        {theme === 'dark' ? (
                                ...
                                <button onClick={logout} className="nav-item" style={{ width: '100%', background: 'transparent', border: 'none', color: 'var(--danger)' }}>
                                    <div className="nav-item-content">
