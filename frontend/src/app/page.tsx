...
const API_URL = `${process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:5000/api"}/employees`;
        ...
        <div style={{ padding: "0.5rem 0" }}>
          ...
          <div style={{ background: "var(--primary-light)", padding: "1.25rem", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "2rem" }}>
            ...
            <div>
              ...
              <div style={{ display: "inline-block", background: "transparent", color: "var(--primary)", padding: "0.5rem 1rem", borderRadius: "6px", fontFamily: "monospace", fontSize: "1.2rem", fontWeight: 800, border: "2px dashed var(--primary)" }}>
